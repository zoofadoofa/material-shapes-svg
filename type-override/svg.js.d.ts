...
declare namespace svgjs {
    ...
    // chamferRect
    export interface ChamferRect extends Path {
        new(): ChamferRect;
        chamfer(width: number, height: number, cut: number): this;
    }

    interface Container {
        chamferRect(width: number, height: number, cut: number): ChamferRect;
    }

    interface Library { ChamferRect: ChamferRect; }
    ...
    interface Element {
        animate(duration?: number, ease?: string|Function, delay?: number): Animation;
        animate(info: { ease?: string|Function; duration?: number; delay?: number }): Animation;
    ...
    export interface MatShadow extends Filter {
        new (): MatShadow;
        elevate(filter: Filter, z: zDepth): MatShadow;
    }

    interface Element {
        matShadow(add: any): any
    }

    interface Library { MatShadow: MatShadow }
    ...
    export interface Animation {
        ...
        radius(x: number, y?: number): Animation;
